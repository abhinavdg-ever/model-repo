...
# V1 kept the catalog beside the weights, so MODELS_DIR was its own folder.
# Here the catalog is part of the package and the weights directory is
# configuration, so it comes from config.NER_MODELS_PATH instead.
