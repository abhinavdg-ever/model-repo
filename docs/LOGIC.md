...
**Stages:** `stages/ocr_final1_docling.py` (Docling layout + RapidOCR; falls back to RapidOCR-onnx on timeout/sparse), `stages/ocr_final2_azure.py` (Azure Document Intelligence `prebuilt-read`)
